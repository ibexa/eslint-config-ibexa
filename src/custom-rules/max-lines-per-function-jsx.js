...
import { getFunctionNameWithKind } from '@eslint-community/eslint-utils';
import { isReturningJSX } from 'eslint-plugin-react/lib/util/jsx.js';

import { upperCaseFirst } from '../shared/string-utils.js';
...
export default {
    ...
    create(context) {
        ...
        /**
         * Identifies is a node is a React Component
         * @param {ASTNode} node Node to test
         * @returns {boolean} True if it's a React Component
         */
        function isReactComponent(node) {
            return isReturningJSX(context, node, true, true);
        }
